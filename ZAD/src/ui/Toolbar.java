...
public class Toolbar extends Bar {
    ...
    private void initPathImgs() {
        pathStart = LoadSave.getSpriteAtlas().getSubimage(5 * 75, 0, 75, 75);
        pathEnd = LoadSave.getSpriteAtlas().getSubimage(4 * 75, 0, 75, 75);
    }

    private void initButtons() {

        bMenu = new MyButton("Menu", 2, 752, 100, 30);
        bSave = new MyButton("Save", 2, 784, 100, 30);
