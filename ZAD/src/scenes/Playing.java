...
public class Playing extends GameScene implements SceneMethods {
    ...
    public Playing(Game game) {
        ...
        actionBar = new ActionBar(0, 750, 1125, 160, this);
    ...
    private void drawHighlight(Graphics g) {
        ...
        g.drawRect(mouseX, mouseY, 75, 75);
    ...
    public void upgradeTower(ATower displayedATower) {
        towerManager.upgradeTower(displayedATower);

    }

    public void removeTower(ATower displayedATower) {
        towerManager.removeTower(displayedATower);
    }
    ...
    public void rewardPlayer(int enemyType) {
        actionBar.addGold(Enemies.GetReward(enemyType));
    }
